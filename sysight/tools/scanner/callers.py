...
CALLERS_TOOL = ToolDef(
    name="scanner_callers",
    description="Find all call-sites of a symbol across the repo (text-based, no imports needed)",
    parameters={
        "type": "object",
        "properties": {
            ...
            "file_filter": {"type": "string", "description": "Restrict search to a specific file"},
