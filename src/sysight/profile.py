...
class NsightSchema:
    ...
    def __init__(self, conn: sqlite3.Connection):
        ...
        self.cuda_callchain_table = _validate_table_name(self._detect_table("CUDA_CALLCHAINS"))
        self.osrt_api_table = _validate_table_name(self._detect_table("OSRT_API"))
        self.osrt_callchain_table = _validate_table_name(self._detect_table("OSRT_CALLCHAINS"))
